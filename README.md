...
Небольшое Windows-приложение для извлечения кадастровых контуров из XML-выписок Росреестра и сохранения их в DXF.
...
- выбор нужных типов записей или выбор всех типов кнопкой **Select all**;
...
1. Нажмите **Open** и выберите XML-выписку Росреестра.
2. Отметьте нужные типы записей или нажмите **Select all**.
